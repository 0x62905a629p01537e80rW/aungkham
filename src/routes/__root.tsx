...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Text on Photo — Native Photo Text Editor" },
      { name: "description", content: "Add beautiful, fully customizable text to your photos. Fonts, colors, stroke, shadow, texture, perspective and more — free, no signup." },
      { property: "og:title", content: "Text on Photo" },
      { property: "og:description", content: "Add beautiful, fully customizable text to your photos." },
