...
export function EditorHeader({
  ...
  return (
    <header
      className={cn(
        'app-header z-30 flex h-14 items-center justify-between px-2 transition-colors duration-200',
          ...
          <div className="flex items-center gap-0.5 rounded-xl bg-secondary/70 px-1 py-1">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="ghost" size="icon" aria-label="Canvas settings" className={iconBtn}>
              ...
              <PopoverContent
                ...
                sideOffset={10}
                collisionPadding={12}
                className="glass-panel w-56 rounded-2xl p-2"
              >
